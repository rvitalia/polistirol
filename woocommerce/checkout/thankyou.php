...
?>
<div class="checkout">
	<div class="container container-main container-checkout">
		<div class="woocommerce-order">
			...
			?>
				...
				<?php else : ?>
					...
					<p class="woocommerce-notice woocommerce-notice--success woocommerce-thankyou-order-received success__inner"><?php echo apply_filters('woocommerce_thankyou_order_received_text', esc_html__('Thank you. Your order has been received.', 'woocommerce'), $order); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
																													?></p>
