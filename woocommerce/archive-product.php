					...
					<?php if ($the_query->have_posts()) : ?>
						...
						<?php while ($the_query->have_posts()) : $the_query->the_post(); ?>
							...
							<div class="adventages__inner__row__item">
								...
								<h5 class="adventages__inner__row__item__title"><?php the_field('adventages_title'); ?></h5>
								<span class="adventages__inner__row__item__text"><?php the_field('advantages_text'); ?> </span>
							</div>
